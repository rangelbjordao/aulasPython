...
# Estututra de controle de fluxo (ou condicoes/decisoes)

H = int(input("Digite um numero: "))

if H > 10: #Se a media harmonica for amior que 10
    print("Media harmonica maior que 10")
    # imprime sempre 2
    # adicionado para exemplificar a execucao de mais de uma instrucao
    print(1 + 1)
elif H == 10:
    print("Media harmonica = 10")
elif H < 0:
    print("Media harmonica negativa")
else:
    print("Media harmonica entre 0 e 10")    

print("fora do if/else") # sempre sera impresso, mesmo que a condicao seja falsa