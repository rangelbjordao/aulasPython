...
# le o arquivo JSON e retorna a lista de pacientes
...
def carrega_pacientes():
    ...
    except:  # se alguma linha dar erro, faça isso no lugar:
        pacientes = []
    finally:  # nao importa qual o caminho percorrido, no final faça isso:
        return pacientes


# recebe a lista de pacientes e escreve seus dados no arquivo JSON
def escreve_pacientes_no_arquivo(pacientes: list):
    # abro arquivo no mode de escrita (Write, por isso o w)
    with open(NOME_ARQUIVO, 'w') as arquivo:
        # parametros: dado a escrever; arquivo; espaçamento da indentaçao (opcional)
